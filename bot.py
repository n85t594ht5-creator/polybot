...
# Схема бакетов движения — общая для бота, отчётов и тестировщика.
# Нижние два бакета в live-журнале всегда пусты: сигналы с move < MIN_MOVE
# отсекаются раньше записи. Их можно увидеть только в Move Analysis тестировщика.
